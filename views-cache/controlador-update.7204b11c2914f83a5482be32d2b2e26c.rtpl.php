  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box box-success">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" id="form" action="/admin/controladores/<?php echo htmlspecialchars( $controlador["id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" method="post">
          <div class="box-body">
            <div class="form-group">
              <label for="name">Nome</label>
              <input type="text" class="form-control" id="name" name="name" placeholder="Digite o nome" value="<?php echo htmlspecialchars( $controlador["name"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
            </div>
            <div class="form-group">
              <label for="ip_address">IP</label>
              <input type="text" class="form-control" id="ip_address" name="ip_address" placeholder="Digite o IP" value="<?php echo htmlspecialchars( $controlador["ip_address"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
            </div>
            ...
            <div  class="form-group">
              ...
              <select id="selPlaces" class="form-control" name="places_id" disabled style="margin-bottom: 10px">
                ...
                <option value="<?php echo htmlspecialchars( $controlador["places_id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><?php echo htmlspecialchars( $controlador["name_place"], ENT_COMPAT, 'UTF-8', FALSE ); ?></option>
            ...
            <div  class="form-group">
              ...
              <select id="selComodo" class="form-control" name="comodos_id" style="margin-bottom: 10px" disabled>
                <option value="<?php echo htmlspecialchars( $controlador["comodos_id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><?php echo htmlspecialchars( $controlador["name_comodo"], ENT_COMPAT, 'UTF-8', FALSE ); ?></option>
              </select>
            </div>
